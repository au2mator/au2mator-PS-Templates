...
# v 1.6 Global Mail Settings,  Better Mail Settings
## TODO: Teams Integration testing and better, Mentions
#
#
...
# PreReq: create a Teams App Reg for Teams Cards when using Teams, starting line 82
#
#################
...
$SendGlobalMail = $false # Using the Mail Settings also in Automation Part
...
if ($SendMailToInitiatedByUser -or $SendMailToTargetUser -or $SendGlobalMail) {
...
try {
    ...
    try {
        ...
        try {
            Write-au2matorLog -Type INFO -Text "Try3"
