...
## au2mator Settings
[string]$PortalURL = "http://localhost:86"
[string]$au2matorDBServer = "demo01"
[string]$au2matorDBName = "au2mator40Demo2"

## Control Mail
$SendMailToInitiatedByUser = $false #Send a Mail after Service is completed
...
$HTML = Get-ApproverMailContent -RequestID $RequestId -RequestTitle $Service -EndDate $UserInput.ApprovedTime -TargetUserId $TargetUserId -InitiatedBy $InitiatedBy -Status $Status -PortalURL $PortalURL -RequestedBy $InitiatedBy -AdditionalHTML $AdditionalHTML -InputHTML $UserInput.html
