...
# v 1.1 Changed/fixed Variables, German Umlaute for Mail, GRAPH API for Mail Send, better Mail Settings
## TODO: Outlook Card, Teams Inegration
#
# Init Release: 01.04.2021
...
# PreReq: au2mator 4.0 or higher required
#
#################
...
[string]$au2matorDBServer = "AVMSRV002"
[string]$au2matorDBName = "au2mator40Demo"
...
$MailMethod = "GRAPHAPI" #SMTP, GRAPHAPI
    ...
    $AzureGraphMailCred_clientID = "" #Fill for Manual AzureGraphMailCred_method
    $AzureGraphMailCred_Clientsecret = "" #Fill for Manual AzureGraphMailCred_method
    $AzureGraphMailCred_tenantID = "" #Fill for Manual AzureGraphMailCred_method
    ...
    elseif ($MailMethod -eq "GRAPHAPI") {
        if ($AzureGraphMailCred_method -eq "Stored") {
...
function Get-UserInput ($RequestID) {
    ...
    $f_RequestInfo = ExecuteSqlQuery -sqlquery "select InitiatedBy, CreatedAt, TargetUserId,[ApprovedBy], [ApprovedTime], Comment from Requests where Id =  '$RequestID'"
    ...
    $return.CreatedAt = $f_RequestInfo.CreatedAt
    $return.HTML = $HTML
...
Function Get-MailContent ($RequestID, $RequestTitle, $EndDate, $TargetUserId, $InitiatedBy, $Status, $PortalURL, $RequestedBy, $AdditionalHTML, $InputHTML) {
    ...
    <td style="border-top: solid #E3E3E3 1.0pt; border-left: none; border-bottom: none; border-right: solid #E3E3E3 1.0pt; mso-border-top-alt: solid #E3E3E3 .75pt; mso-border-right-alt: solid #E3E3E3 .75pt; padding: 0cm 0cm 3.75pt 0cm; font-color: #0000;"><strong>Request Date</strong>: ##EndDate</td>
    </tr>
    ...
    <tr style="mso-yfti-irow: 1; box-sizing: border-box;">
    <td style="padding: 0cm 0cm 15.0pt 0cm; box-sizing: border-box;" valign="top">
    <p class="MsoNormal" style="line-height: 19.2pt;"><span style="font-size: 10.5pt; font-family: 'Helvetica',sans-serif; mso-fareast-font-family: 'Times New Roman';">The Request <strong>"##RequestTitle"</strong> is waiting for an approval!<br /> <br /> You will be notified, once the Request was approved:<br /><b>##HTMLINFO&nbsp;</b><br /></span></p>
    <div>&nbsp;</div>
...
Function Get-ApproverMailContent ($RequestID, $RequestTitle, $EndDate, $TargetUserId, $InitiatedBy, $Status, $PortalURL, $RequestedBy, $AdditionalHTML, $InputHTML) {
    ...
    <tr style="mso-yfti-irow: 1; box-sizing: border-box;">
    <td style="padding: 0cm 0cm 15.0pt 0cm; box-sizing: border-box;" valign="top">
    <p class="MsoNormal" style="line-height: 19.2pt;"><span style="font-size: 10.5pt; font-family: 'Helvetica',sans-serif; mso-fareast-font-family: 'Times New Roman';">the Request <strong>"##RequestTitle"</strong> has been started and is waiting for your Approval.<br /> <br /> Please see the description for detailed information.<br /><b>##HTMLINFO&nbsp;</b><br /></span></p>
    <div>&nbsp;</div>
    <div>See the Details of the Request</div>
    <div>##InputHTML</div>
    <div>&nbsp;</div>
    ...
    <tr style="mso-yfti-irow: 2; mso-yfti-lastrow: yes; box-sizing: border-box;">
    <td style="padding: 0cm 0cm 15.0pt 0cm; box-sizing: border-box;" valign="top">
    <p class="MsoNormal" style="text-align: center; line-height: 19.2pt;" align="center"><span style="font-size: 10.5pt; font-family: 'Helvetica',sans-serif; mso-fareast-font-family: 'Times New Roman';"><a style="border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; display: inline-block;" href="##RequestLink"><strong><span style="color: white; border: solid #50D691 6.0pt; padding: 0cm; background: #50D691; text-decoration: none; text-underline: none;">Navigate to the Request</span></strong></a></span></p>
    </td>
    </tr>
    </tbody>
    </table>
...
Write-au2matorLog -Type INFO -Text "Send Mail to Approver"

$SamApprover = $ApproverUserId.Split("\")[1]
$ObjectApprover = Get-ADUser -Identity $SamApprover -Properties Mail

$UserInput = Get-UserInput -RequestID $RequestId
$HTML = Get-ApproverMailContent -RequestID $RequestId -RequestTitle $Service -EndDate $UserInput.CreatedAt -TargetUserId $TargetUserId -InitiatedBy $InitiatedBy -Status $Status -PortalURL $PortalURL -RequestedBy $InitiatedBy -AdditionalHTML $AdditionalHTML -InputHTML "$($UserInput.html)"
Send-ServiceMail -HTMLBody $HTML -RequestID $RequestId -Recipient "$($ObjectApprover.Mail)" -RequestStatus $Status -ServiceName $Service
...
if ($SendMailToInitiatedByUser) {
    ...
    $UserInput = Get-UserInput -RequestID $RequestId
    $HTML = Get-MailContent -RequestID $RequestId -RequestTitle $Service -EndDate $UserInput.CreatedAt -TargetUserId $TargetUserId -InitiatedBy $InitiatedBy -Status $Status -PortalURL $PortalURL -RequestedBy $InitiatedBy -AdditionalHTML $AdditionalHTML -InputHTML $UserInput.html
